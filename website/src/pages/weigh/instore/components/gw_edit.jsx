...
import { Tag, Modal, Form, Input, message, Image } from 'antd';
...
const GWEdit = (props) => {
  ...
  if (current && current.createDateTime) {
    imgPath =
      current.createDateTime.substring(0, current.createDateTime.indexOf('T')) +
      '/' +
      current.id +
      '_gross.jpg';
  }
  ...
  const getImg = () => {
    if (current && current.createDateTime) {
      const imgPath =
        ...
        console.log('../../../../../../pictures/memoin/' + imgPath + '_gross.jpg');
      try {
        return (
          <Image
            width={220}
